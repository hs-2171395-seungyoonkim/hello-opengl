...
enum Human_Pose {
	base, armLeftUp,
	walk_a, walk_b      // walking keyframes (walk_a: left leg forward, walk_b: right leg forward)
};
...
public:
   ...
   glm::quat	BoneRotate[BONENUM];
	...
	void DrawHuman(Shader shader, unsigned int sphereVAO, int nSphereVert, glm::mat4 model)
	{
		...
		// draw spine
		bone = glm::translate(bone, glm::vec3(0.0f, BoneLength[pelvis] + BoneLength[spine], 0.0f));
		...
		mspine = bone;
		// draw neck
		bone = glm::translate(bone, glm::vec3(0.0f, BoneLength[spine] + BoneLength[neck], 0.0f));
		...
		// draw head
		bone = glm::translate(bone, glm::vec3(0.0f, BoneLength[neck] + BoneLength[head], 0.0f));
		...
		shader.setMat4("model", bone);
		shader.setVec3("objectColor", 0.6f, 0.2f, 0.2f);
		glBindVertexArray(sphereVAO);
		glDrawArrays(GL_TRIANGLES, 0, nSphereVert);
		...
		shader.setMat4("model", bone);
		shader.setVec3("objectColor", 0.4f, 0.15f, 0.15f);
		glBindVertexArray(sphereVAO);
		glDrawArrays(GL_TRIANGLES, 0, nSphereVert);
		...
		shader.setMat4("model", bone);
		shader.setVec3("objectColor", 0.3f, 0.1f, 0.1f);
		glBindVertexArray(sphereVAO);
		glDrawArrays(GL_TRIANGLES, 0, nSphereVert);
	...
	void SetupPoses()
	{
		for (int p = 0; p < POSENUM; p++)
		{
			...
			case base:
				...
				Pose[base][forearmL] = glm::angleAxis(glm::radians(  0.f), glm::vec3(0.f, 1.f, 0.f)); // neutral
				Pose[base][forearmR] = glm::angleAxis(glm::radians(  0.f), glm::vec3(0.f, 1.f, 0.f)); // neutral
				break;
			case armLeftUp:
			...
			case walk_a:
				Pose[walk_a][clavicleL]  = glm::angleAxis(glm::radians(180.f), glm::vec3(0.f, 0.f, 1.f));
				Pose[walk_a][clavicleR]  = glm::angleAxis(glm::radians(180.f), glm::vec3(0.f, 0.f, 1.f));
				Pose[walk_a][upperarmL]  = glm::angleAxis(glm::radians(-30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_a][upperarmR]  = glm::angleAxis(glm::radians(+30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_a][thighL]     = glm::angleAxis(glm::radians(-30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_a][calfL]      = glm::angleAxis(glm::radians( -5.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_a][thighR]     = glm::angleAxis(glm::radians( 30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_a][calfR]      = glm::angleAxis(glm::radians( 45.f), glm::vec3(1.f, 0.f, 0.f)); 
				break;
			
			case walk_b:
				Pose[walk_b][clavicleL]  = glm::angleAxis(glm::radians(180.f), glm::vec3(0.f, 0.f, 1.f));
				Pose[walk_b][clavicleR]  = glm::angleAxis(glm::radians(180.f), glm::vec3(0.f, 0.f, 1.f));
				Pose[walk_b][upperarmL]  = glm::angleAxis(glm::radians(+30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_b][upperarmR]  = glm::angleAxis(glm::radians(-30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_b][thighL]     = glm::angleAxis(glm::radians( 30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_b][calfL]      = glm::angleAxis(glm::radians( 45.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_b][thighR]     = glm::angleAxis(glm::radians(-30.f), glm::vec3(1.f, 0.f, 0.f)); 
				Pose[walk_b][calfR]      = glm::angleAxis(glm::radians( -5.f), glm::vec3(1.f, 0.f, 0.f)); 
				break;
			default:
				;
			};
